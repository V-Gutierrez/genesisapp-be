...
-- AddForeignKey
ALTER TABLE "ExternalSubscriptions" ADD CONSTRAINT "ExternalSubscriptions_externalEventId_fkey" FOREIGN KEY ("externalEventId") REFERENCES "ExternalEvent"("id") ON DELETE SET NULL ON UPDATE CASCADE;
