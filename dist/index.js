              ...
              this.app.post('/api/auth', (e, t) =>
                s(this, void 0, void 0, function* () {
                  try {
                    ...
                    const { email: i, password: l } = e.body,
                      f = yield a.default.user.findFirst({
                        where: { email: i },
                        select: { password: !0, email: !0, id: !0, role: !0 },
                      })
                    if (!f) return t.sendStatus(401)
                    if (!(yield n.default.comparePassword(l, f.password))) return t.sendStatus(401)
                    {
        ...
        t.default = class {
          ...
          static JWT(e) {
            e.use((e, t, r) => {
              ...
              const i = s
              u.default.verify(i, process.env.ACCESS_TOKEN_SECRET, (e, s) => {
