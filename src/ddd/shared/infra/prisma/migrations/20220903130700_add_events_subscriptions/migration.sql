...
-- AddForeignKey
ALTER TABLE "EventsSubscriptions" ADD CONSTRAINT "EventsSubscriptions_eventId_fkey" FOREIGN KEY ("eventId") REFERENCES "Events"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
